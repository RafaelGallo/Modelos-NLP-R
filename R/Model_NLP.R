...
data <- read_csv("G:/Meu Drive/Machine learning e deep learning/Cursos - Google Drive/DSA/Formação cientista de dados 2.0/Big Data Analytics com R e Microsoft Azure Machine Learning/ML Big data analytics - Projetos/Análise de Redes Sociais/Project r/Sentiment_Data.csv")
data
...
###### Etapa 5 - Wordcloud, associação entre as palavras e dendograma ######
...
# R: O modelo Naive Bayes tem o melhor desempenho com 99% de precisão em comparação.
# Naive Bayes trabalha com a suposição de que as características do conjunto de dados são independentes umas das outras – por isso são chamadas de Naive.
# Funciona bem para modelos de pacote de palavras, também conhecidos como documentos de texto, pois as palavras em um documento de texto são independentes umas das outras; 
